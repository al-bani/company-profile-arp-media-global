                ...
                <form action="/dashboard/berita/{{ $berita->id }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="ms-1 form-select btn btn-secondary" aria-label="Default select example"
                            name="id_perusahaan" id="id_perusahaan" value="{{ $berita->id_perusahaan }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="foto" name="foto"
                            value="{{ $berita->foto }}" accept="image/*" onchange="previewImage(event)">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="konten" id="konten" rows="6" class="form-control" value="{{ $berita->konten }}"></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="penulis" id="penulis" class="form-control"
                            value="{{ $berita->penulis }}" placeholder="Nama penulis">
                    </div>
